...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("x_V", 128, hls_in, 0, "ap_vld", "in_data", 1),
	Port_Property("x_V_ap_vld", 1, hls_in, 0, "ap_vld", "in_vld", 1),
	Port_Property("y_0_V", 8, hls_out, 1, "ap_vld", "out_data", 1),
	Port_Property("y_0_V_ap_vld", 1, hls_out, 1, "ap_vld", "out_vld", 1),
	Port_Property("y_1_V", 8, hls_out, 2, "ap_vld", "out_data", 1),
	Port_Property("y_1_V_ap_vld", 1, hls_out, 2, "ap_vld", "out_vld", 1),
	Port_Property("y_2_V", 8, hls_out, 3, "ap_vld", "out_data", 1),
	Port_Property("y_2_V_ap_vld", 1, hls_out, 3, "ap_vld", "out_vld", 1),
	Port_Property("y_3_V", 8, hls_out, 4, "ap_vld", "out_data", 1),
	Port_Property("y_3_V_ap_vld", 1, hls_out, 4, "ap_vld", "out_vld", 1),
	Port_Property("y_4_V", 8, hls_out, 5, "ap_vld", "out_data", 1),
