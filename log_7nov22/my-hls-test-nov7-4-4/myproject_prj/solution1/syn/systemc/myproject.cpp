...
const sc_lv<4> myproject::ap_const_lv4_F = "1111";
...
void myproject::thread_p_Val2_s_fu_93_p4() {
    p_Val2_s_fu_93_p4 = x_V_in_sig.read().range(59, 56);
}

void myproject::thread_tmp_1_fu_103_p4() {
    tmp_1_fu_103_p4 = x_V_in_sig.read().range(15, 12);
}
...
void myproject::thread_xor_ln703_fu_113_p2() {
    xor_ln703_fu_113_p2 = (p_Val2_s_fu_93_p4.read() ^ ap_const_lv4_F);
}

void myproject::thread_y_0_V() {
    y_0_V = ap_const_lv4_F;
}
...
void myproject::thread_y_2_V() {
    y_2_V = (!tmp_1_fu_103_p4.read().is_01() || !xor_ln703_fu_113_p2.read().is_01())? sc_lv<4>(): (sc_biguint<4>(tmp_1_fu_103_p4.read()) + sc_biguint<4>(xor_ln703_fu_113_p2.read()));
}
