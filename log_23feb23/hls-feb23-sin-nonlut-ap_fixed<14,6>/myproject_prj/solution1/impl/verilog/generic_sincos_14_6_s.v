...
wire   [13:0] p_Val2_s_fu_83_p3;
reg   [13:0] p_Val2_s_reg_286;
...
wire   [14:0] z_V_1_fu_185_p3;
reg   [14:0] z_V_1_reg_308;
...
wire   [15:0] grp_cordic_circ_apfixed_16_3_0_s_fu_66_ap_return;
reg   [15:0] y_V_reg_319;
reg   [9:0] trunc_ln_reg_324;
reg    grp_cordic_circ_apfixed_16_3_0_s_fu_66_ap_ce;
...
wire   [13:0] inabs_V_fu_77_p2;
wire   [34:0] r_V_39_fu_263_p2;
wire   [20:0] lhs_V_fu_116_p3;
wire   [22:0] grp_fu_271_p3;
wire   [14:0] p_Val2_46_fu_127_p4;
wire   [13:0] trunc_ln708_s_fu_145_p4;
wire   [15:0] rhs_V_10_fu_141_p1;
wire   [15:0] ret_V_51_fu_158_p2;
wire   [0:0] icmp_ln251_fu_174_p2;
wire   [0:0] or_ln251_fu_179_p2;
wire   [14:0] trunc_ln708_16_fu_164_p4;
wire   [14:0] z_V_fu_154_p1;
wire   [16:0] zext_ln703_fu_208_p1;
wire   [16:0] sub_ln1253_fu_211_p2;
wire   [9:0] trunc_ln708_17_fu_217_p4;
wire   [0:0] xor_ln879_fu_233_p2;
wire   [0:0] and_ln879_fu_238_p2;
wire   [9:0] select_ln879_fu_227_p3;
wire   [9:0] p_Val2_49_fu_243_p3;
wire   [9:0] sub_ln703_fu_250_p2;
wire   [13:0] r_V_39_fu_263_p0;
wire   [21:0] r_V_39_fu_263_p1;
wire   [5:0] grp_fu_271_p0;
wire   [16:0] grp_fu_271_p1;
wire   [20:0] grp_fu_271_p2;
wire   [9:0] p_Val2_50_fu_256_p3;
reg    ap_ce_reg;
reg   [13:0] in_V_int_reg;
reg   [9:0] ap_return_int_reg;
wire   [21:0] grp_fu_271_p00;
wire   [22:0] grp_fu_271_p20;
wire   [34:0] r_V_39_fu_263_p00;
...
myproject_mul_mul_14ns_22ns_35_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 14 ),
    .din1_WIDTH( 22 ),
    .dout_WIDTH( 35 ))
myproject_mul_mul_14ns_22ns_35_1_0_U2(
    .din0(r_V_39_fu_263_p0),
    .din1(r_V_39_fu_263_p1),
    .dout(r_V_39_fu_263_p2)
);

myproject_mac_mulsub_6ns_17ns_21ns_23_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 6 ),
    .din1_WIDTH( 17 ),
    .din2_WIDTH( 21 ),
    .dout_WIDTH( 23 ))
myproject_mac_mulsub_6ns_17ns_21ns_23_1_0_U3(
    .din0(grp_fu_271_p0),
    .din1(grp_fu_271_p1),
    .din2(grp_fu_271_p2),
    .dout(grp_fu_271_p3)
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_ce_reg))) begin
        ...
        k_V_reg_296 <= {{r_V_39_fu_263_p2[30:29]}};
        p_Val2_s_reg_286 <= p_Val2_s_fu_83_p3;
        ret_V_reg_291 <= {{r_V_39_fu_263_p2[34:29]}};
        ...
        trunc_ln_reg_324 <= {{grp_cordic_circ_apfixed_16_3_0_s_fu_66_ap_return[14:5]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp34) & (1'b1 == ap_ce_reg))) begin
        grp_cordic_circ_apfixed_16_3_0_s_fu_66_ap_ce = 1'b1;
    end else begin
        grp_cordic_circ_apfixed_16_3_0_s_fu_66_ap_ce = 1'b0;
    end
end
...
assign grp_fu_271_p1 = 22'd51471;
...
assign inabs_V_fu_77_p2 = (14'd0 - in_V_int_reg);

assign lhs_V_fu_116_p3 = {{p_Val2_s_reg_286}, {7'd0}};

assign or_ln251_fu_179_p2 = (icmp_ln879_fu_136_p2 | icmp_ln251_fu_174_p2);

assign p_Val2_46_fu_127_p4 = {{grp_fu_271_p3[15:1]}};

assign p_Val2_49_fu_243_p3 = ((and_ln879_fu_238_p2[0:0] === 1'b1) ? trunc_ln_reg_324 : select_ln879_fu_227_p3);

assign p_Val2_50_fu_256_p3 = ((sign0_V_reg_281_pp0_iter6_reg[0:0] === 1'b1) ? p_Val2_49_fu_243_p3 : sub_ln703_fu_250_p2);
...
assign r_V_39_fu_263_p1 = 35'd1335088;

assign ret_V_51_fu_158_p2 = (16'd25735 - rhs_V_10_fu_141_p1);

assign rhs_V_10_fu_141_p1 = p_Val2_46_fu_127_p4;

assign select_ln879_fu_227_p3 = ((icmp_ln879_1_reg_313_pp0_iter6_reg[0:0] === 1'b1) ? trunc_ln_reg_324 : trunc_ln708_17_fu_217_p4);

assign sign0_V_fu_71_p2 = (($signed(in_V_int_reg) > $signed(14'd0)) ? 1'b1 : 1'b0);

assign sub_ln1253_fu_211_p2 = (17'd0 - zext_ln703_fu_208_p1);

assign sub_ln703_fu_250_p2 = (10'd0 - p_Val2_49_fu_243_p3);

assign trunc_ln708_16_fu_164_p4 = {{ret_V_51_fu_158_p2[15:1]}};

assign trunc_ln708_17_fu_217_p4 = {{sub_ln1253_fu_211_p2[14:5]}};

assign trunc_ln708_s_fu_145_p4 = {{grp_fu_271_p3[15:2]}};
