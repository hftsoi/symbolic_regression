...
set id 31
set name myproject_mac_muladd_12s_8s_18s_20_1_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 20
set exp i0*i1+i2
set arg_lists {i0 {12 1 +} i1 {8 1 +} m {20 1 +} i2 {18 1 +} p {20 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set id 32
set name myproject_mac_muladd_18s_7s_24s_25_1_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 25
set exp i0*i1+i2
set arg_lists {i0 {18 1 +} i1 {7 1 +} m {25 1 +} i2 {24 1 +} p {25 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set id 33
set name myproject_mul_mul_17s_20s_40_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 40
set exp i0*i1
set arg_lists {i0 {17 1 +} i1 {20 1 +} p {40 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set id 34
set name myproject_mul_mul_16s_25s_43_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 43
set exp i0*i1
set arg_lists {i0 {16 1 +} i1 {25 1 +} p {43 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
