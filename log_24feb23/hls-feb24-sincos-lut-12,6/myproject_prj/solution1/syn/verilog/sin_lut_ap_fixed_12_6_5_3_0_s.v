...
module sin_lut_ap_fixed_12_6_5_3_0_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [5:0] p_Val2_16_reg_734;
reg   [5:0] p_Val2_16_reg_734_pp0_iter1_reg;
reg   [2:0] luTdex1_V_reg_743;
reg   [2:0] luTdex1_V_reg_743_pp0_iter1_reg;
...
reg   [0:0] tmp_5_reg_759_pp0_iter1_reg;
reg   [5:0] p_Result_s_fu_210_p4;
reg   [5:0] p_Result_s_reg_764;
...
wire   [6:0] zext_ln1265_fu_561_p1;
wire   [6:0] select_ln143_fu_581_p3;
wire   [6:0] sub_ln703_fu_589_p2;
...
wire   [6:0] select_ln151_1_fu_683_p3;
wire   [0:0] or_ln141_fu_609_p2;
wire   [0:0] or_ln151_fu_677_p2;
wire   [7:0] select_ln151_fu_669_p3;
wire   [7:0] zext_ln151_fu_691_p1;
wire   [0:0] or_ln151_2_fu_695_p2;
wire   [0:0] or_ln151_3_fu_709_p2;
wire   [7:0] select_ln151_2_fu_701_p3;
wire  signed [7:0] sext_ln703_fu_595_p1;
...
myproject_mul_mul_15ns_12s_27_1_1 #(
    ...
    .din1_WIDTH( 12 ),
    .dout_WIDTH( 27 ))
myproject_mul_mul_15ns_12s_27_1_1_U5(
    .din0(r_V_fu_723_p0),
    .din1(input_V),
    .dout(r_V_fu_723_p2)
);
...
assign add_ln899_fu_321_p2 = (6'd11 + trunc_ln894_fu_244_p1);
...
assign icmp_ln142_fu_555_p2 = ((tmp_6_fu_545_p4 == 2'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln885_fu_535_p2 = ((p_Val2_16_reg_734_pp0_iter1_reg != 6'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_1_fu_295_p2 = ((p_Result_4_fu_290_p2 != 6'd0) ? 1'b1 : 1'b0);

assign icmp_ln897_fu_264_p2 = (($signed(tmp_7_fu_254_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign lshr_ln897_fu_284_p2 = 6'd63 >> zext_ln897_fu_280_p1;

assign lshr_ln908_fu_397_p2 = zext_ln907_1_fu_389_p1 >> add_ln908_fu_392_p2;

assign luTdex_V_1_fu_373_p3 = ((tmp_5_reg_759_pp0_iter1_reg[0:0] === 1'b1) ? sub_ln214_fu_367_p2 : p_Result_12_fu_360_p3);
...
assign or_ln151_1_fu_637_p2 = (grp_fu_157_p2 | grp_fu_152_p2);
...
assign or_ln152_fu_653_p2 = (grp_fu_167_p2 | grp_fu_162_p2);
...
assign p_Result_12_fu_360_p3 = {{luTdex1_V_reg_743_pp0_iter1_reg}, {6'd0}};

assign p_Result_13_fu_219_p3 = {{26'd67108863}, {p_Result_s_reg_764}};
...
always @ (r_V_fu_723_p2) begin
    for (ap_tvar_int_0 = 6 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 21 - 16) begin
            ...
            p_Result_s_fu_210_p4[ap_tvar_int_0] = r_V_fu_723_p2[21 - ap_tvar_int_0];
        end
    end
end

assign r_V_fu_723_p0 = 27'd10430;
...
assign select_ln151_fu_669_p3 = ((and_ln151_fu_648_p2[0:0] === 1'b1) ? 8'd45 : 8'd210);

assign select_ln915_fu_471_p3 = ((tmp_9_fu_452_p3[0:0] === 1'b1) ? add_ln915_fu_465_p2 : sub_ln915_fu_460_p2);
...
assign sub_ln703_fu_589_p2 = (7'd0 - select_ln143_fu_581_p3);

assign sub_ln894_fu_238_p2 = (32'd6 - l_fu_226_p3);

assign sub_ln897_fu_274_p2 = ($signed(3'd4) - $signed(trunc_ln897_fu_270_p1));
...
assign tmp_6_fu_545_p4 = {{add_ln142_fu_540_p2[2:1]}};

assign tmp_7_fu_254_p4 = {{lsb_index_fu_248_p2[31:1]}};

assign tmp_8_fu_307_p3 = lsb_index_fu_248_p2[32'd31];

assign tmp_9_fu_452_p3 = m_2_fu_432_p2[32'd54];

assign trunc_ln3_fu_507_p4 = {{m_2_fu_432_p2[52:1]}};

assign trunc_ln893_fu_234_p1 = l_fu_226_p3[10:0];

assign trunc_ln894_fu_244_p1 = sub_ln894_fu_238_p2[5:0];

assign trunc_ln897_fu_270_p1 = sub_ln894_fu_238_p2[2:0];

assign xor_ln899_fu_315_p2 = (tmp_8_fu_307_p3 ^ 1'd1);
...
endmodule //sin_lut_ap_fixed_12_6_5_3_0_s
