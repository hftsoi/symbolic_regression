...
// ==============================================================
#ifndef __myproject_dcmp_64ns_64ns_1_2_0__HH__
#define __myproject_dcmp_64ns_64ns_1_2_0__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_dcmp_64ns_64ns_1_2_0) {
    ...
    SC_CTOR(myproject_dcmp_64ns_64ns_1_2_0):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
