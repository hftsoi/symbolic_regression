set moduleName generic_sincos_10_6_s
set isTopModule 0
...
set C_modelName {generic_sincos<10, 6>}
set C_modelType { int 12 }
set C_modelArgList {
	{ in_V int 10 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "in_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_cordic_circ_apfixed_12_3_0_s_fu_70", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_mul_mul_18ns_10ns_27_1_0_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_mac_mulsub_13ns_6ns_17ns_19_1_0_U3", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	in_V { ap_none {  { in_V in_data 0 10 } } }
}
