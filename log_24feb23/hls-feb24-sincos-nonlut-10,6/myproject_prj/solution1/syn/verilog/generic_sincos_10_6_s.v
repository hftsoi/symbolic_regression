...
wire   [9:0] p_Val2_s_fu_87_p3;
reg   [9:0] p_Val2_s_reg_386;
...
wire   [10:0] z_V_1_fu_189_p3;
reg   [10:0] z_V_1_reg_410;
reg   [11:0] x_V_reg_415;
wire   [10:0] trunc_ln266_fu_205_p1;
reg   [10:0] trunc_ln266_reg_420;
reg   [5:0] trunc_ln1_reg_425;
wire   [10:0] trunc_ln1253_fu_219_p1;
reg   [10:0] trunc_ln1253_reg_431;
wire   [11:0] grp_cordic_circ_apfixed_12_3_0_s_fu_70_ap_return_0;
wire   [11:0] grp_cordic_circ_apfixed_12_3_0_s_fu_70_ap_return_1;
reg    grp_cordic_circ_apfixed_12_3_0_s_fu_70_ap_ce;
...
wire   [9:0] inabs_V_fu_81_p2;
wire   [26:0] r_V_48_fu_363_p2;
wire   [16:0] lhs_V_fu_120_p3;
wire   [18:0] grp_fu_371_p3;
wire   [10:0] p_Val2_43_fu_131_p4;
wire   [9:0] trunc_ln708_s_fu_149_p4;
wire   [11:0] rhs_V_5_fu_145_p1;
wire   [11:0] ret_V_42_fu_162_p2;
wire   [0:0] icmp_ln251_fu_178_p2;
wire   [0:0] or_ln251_fu_183_p2;
wire   [10:0] trunc_ln708_11_fu_168_p4;
wire   [10:0] z_V_fu_158_p1;
wire   [10:0] r_V_50_fu_228_p2;
wire   [10:0] r_V_51_fu_248_p2;
wire   [0:0] icmp_ln879_1_fu_223_p2;
wire   [5:0] trunc_ln708_13_fu_253_p4;
wire   [0:0] xor_ln879_fu_270_p2;
wire   [0:0] and_ln879_fu_276_p2;
wire   [5:0] select_ln879_fu_263_p3;
wire   [0:0] or_ln879_fu_288_p2;
wire   [0:0] icmp_ln879_2_fu_243_p2;
wire   [0:0] xor_ln879_1_fu_293_p2;
wire   [0:0] and_ln879_1_fu_299_p2;
wire   [5:0] select_ln879_1_fu_281_p3;
wire   [5:0] trunc_ln708_12_fu_233_p4;
wire   [5:0] trunc_ln3_fu_313_p4;
wire   [5:0] select_ln879_3_fu_322_p3;
wire   [5:0] p_Val2_49_fu_305_p3;
wire   [5:0] sub_ln703_fu_338_p2;
wire   [5:0] p_Val2_50_fu_344_p3;
wire   [5:0] select_ln879_4_fu_330_p3;
wire   [17:0] r_V_48_fu_363_p0;
wire   [9:0] r_V_48_fu_363_p1;
wire   [12:0] grp_fu_371_p0;
...
wire   [17:0] grp_fu_371_p10;
wire   [18:0] grp_fu_371_p20;
wire   [26:0] r_V_48_fu_363_p10;
...
myproject_mul_mul_18ns_10ns_27_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 18 ),
    .din1_WIDTH( 10 ),
    .dout_WIDTH( 27 ))
myproject_mul_mul_18ns_10ns_27_1_0_U2(
    .din0(r_V_48_fu_363_p0),
    .din1(r_V_48_fu_363_p1),
    .dout(r_V_48_fu_363_p2)
);

myproject_mac_mulsub_13ns_6ns_17ns_19_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 13 ),
    .din1_WIDTH( 6 ),
    .din2_WIDTH( 17 ),
    .dout_WIDTH( 19 ))
myproject_mac_mulsub_13ns_6ns_17ns_19_1_0_U3(
    .din0(grp_fu_371_p0),
    .din1(grp_fu_371_p1),
    .din2(grp_fu_371_p2),
    .dout(grp_fu_371_p3)
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_ce_reg) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        k_V_reg_396 <= {{r_V_48_fu_363_p2[22:21]}};
        ...
        ret_V_reg_391 <= {{r_V_48_fu_363_p2[26:21]}};
        ...
        trunc_ln1_reg_425 <= {{grp_cordic_circ_apfixed_12_3_0_s_fu_70_ap_return_1[10:5]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp32) & (1'b1 == ap_ce_reg))) begin
        grp_cordic_circ_apfixed_12_3_0_s_fu_70_ap_ce = 1'b1;
    end else begin
        grp_cordic_circ_apfixed_12_3_0_s_fu_70_ap_ce = 1'b0;
    end
end

assign and_ln879_1_fu_299_p2 = (xor_ln879_1_fu_293_p2 & icmp_ln879_2_fu_243_p2);

assign and_ln879_fu_276_p2 = (xor_ln879_fu_270_p2 & icmp_ln879_reg_404_pp0_iter5_reg);
...
assign icmp_ln879_1_fu_223_p2 = ((k_V_reg_396_pp0_iter5_reg == 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln879_2_fu_243_p2 = ((k_V_reg_396_pp0_iter5_reg == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln879_fu_140_p2 = ((k_V_reg_396 == 2'd1) ? 1'b1 : 1'b0);

assign inabs_V_fu_81_p2 = (10'd0 - in_V_int_reg);

assign lhs_V_fu_120_p3 = {{p_Val2_s_reg_386}, {7'd0}};

assign or_ln251_fu_183_p2 = (icmp_ln879_fu_140_p2 | icmp_ln251_fu_178_p2);

assign or_ln879_fu_288_p2 = (icmp_ln879_reg_404_pp0_iter5_reg | icmp_ln879_1_fu_223_p2);

assign p_Val2_43_fu_131_p4 = {{grp_fu_371_p3[11:1]}};

assign p_Val2_49_fu_305_p3 = ((and_ln879_1_fu_299_p2[0:0] === 1'b1) ? trunc_ln708_13_fu_253_p4 : select_ln879_1_fu_281_p3);

assign p_Val2_50_fu_344_p3 = ((sign0_V_reg_381_pp0_iter5_reg[0:0] === 1'b1) ? p_Val2_49_fu_305_p3 : sub_ln703_fu_338_p2);

assign p_Val2_s_fu_87_p3 = ((sign0_V_fu_75_p2[0:0] === 1'b1) ? in_V_int_reg : inabs_V_fu_81_p2);

assign r_V_48_fu_363_p0 = 27'd83443;

assign r_V_48_fu_363_p1 = r_V_48_fu_363_p10;

assign r_V_48_fu_363_p10 = p_Val2_s_fu_87_p3;

assign r_V_50_fu_228_p2 = (11'd0 - trunc_ln1253_reg_431);

assign r_V_51_fu_248_p2 = (11'd0 - trunc_ln266_reg_420);

assign ret_V_42_fu_162_p2 = (12'd1608 - rhs_V_5_fu_145_p1);

assign rhs_V_5_fu_145_p1 = p_Val2_43_fu_131_p4;

assign select_ln879_1_fu_281_p3 = ((and_ln879_fu_276_p2[0:0] === 1'b1) ? trunc_ln1_reg_425 : select_ln879_fu_263_p3);

assign select_ln879_3_fu_322_p3 = ((and_ln879_fu_276_p2[0:0] === 1'b1) ? trunc_ln708_12_fu_233_p4 : trunc_ln3_fu_313_p4);

assign select_ln879_4_fu_330_p3 = ((and_ln879_1_fu_299_p2[0:0] === 1'b1) ? trunc_ln708_12_fu_233_p4 : select_ln879_3_fu_322_p3);

assign select_ln879_fu_263_p3 = ((icmp_ln879_1_fu_223_p2[0:0] === 1'b1) ? trunc_ln1_reg_425 : trunc_ln708_13_fu_253_p4);

assign sign0_V_fu_75_p2 = (($signed(in_V_int_reg) > $signed(10'd0)) ? 1'b1 : 1'b0);

assign sub_ln703_fu_338_p2 = (6'd0 - p_Val2_49_fu_305_p3);

assign trunc_ln1253_fu_219_p1 = grp_cordic_circ_apfixed_12_3_0_s_fu_70_ap_return_0[10:0];

assign trunc_ln266_fu_205_p1 = grp_cordic_circ_apfixed_12_3_0_s_fu_70_ap_return_1[10:0];

assign trunc_ln3_fu_313_p4 = {{x_V_reg_415[10:5]}};

assign trunc_ln708_11_fu_168_p4 = {{ret_V_42_fu_162_p2[11:1]}};

assign trunc_ln708_12_fu_233_p4 = {{r_V_50_fu_228_p2[10:5]}};

assign trunc_ln708_13_fu_253_p4 = {{r_V_51_fu_248_p2[10:5]}};

assign trunc_ln708_s_fu_149_p4 = {{grp_fu_371_p3[11:2]}};
