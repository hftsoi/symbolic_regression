...
architecture behav of operator_1 is 
    ...
    signal cos_lut_samples_V_q0 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal zext_ln57_fu_187_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal lhs_V_fu_59_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal ret_V_fu_63_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_fu_69_p4 : STD_LOGIC_VECTOR (12 downto 0);
    signal trunc_ln851_fu_91_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal p_Result_4_fu_95_p3 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    component operator_1_cos_lut_samples_V IS
    generic (
        DataWidth : INTEGER;
...
begin
    cos_lut_samples_V_U : component operator_1_cos_lut_samples_V
    generic map (
        DataWidth => 9,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    ap_return <= cos_lut_samples_V_q0;
    cos_lut_samples_V_address0 <= zext_ln57_fu_187_p1(10 - 1 downto 0);

    cos_lut_samples_V_ce0_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_ce)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln851_fu_103_p2 <= "1" when (p_Result_4_fu_95_p3 = ap_const_lv14_0) else "0";
        lhs_V_fu_59_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(n_V),17));

    or_ln55_fu_173_p2 <= (tmp_2_fu_135_p3 or icmp_ln56_fu_153_p2);
    p_Result_4_fu_95_p3 <= (trunc_ln851_fu_91_p1 & ap_const_lv10_0);
    ret_V_1_fu_109_p2 <= std_logic_vector(unsigned(ap_const_lv14_1) + unsigned(sext_ln835_fu_79_p1));
    ret_V_fu_63_p2 <= std_logic_vector(unsigned(ap_const_lv17_2000) + unsigned(lhs_V_fu_59_p1));
