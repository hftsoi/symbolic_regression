...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module myproject_sin_lut_samples_V_rom (
...
initial begin
    $readmemh("./myproject_sin_lut_samples_V_rom.dat", ram0);
    $readmemh("./myproject_sin_lut_samples_V_rom.dat", ram1);
    $readmemh("./myproject_sin_lut_samples_V_rom.dat", ram2);
    $readmemh("./myproject_sin_lut_samples_V_rom.dat", ram3);
    $readmemh("./myproject_sin_lut_samples_V_rom.dat", ram4);
end
...
`timescale 1 ns / 1 ps
module myproject_sin_lut_samples_V(
    reset,
    clk,
    address0,
    ce0,
...
myproject_sin_lut_samples_V_rom myproject_sin_lut_samples_V_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
