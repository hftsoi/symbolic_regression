...
entity myproject_sin_lut_samples_V_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 10; 
...
architecture rtl of myproject_sin_lut_samples_V_rom is 
...
entity myproject_sin_lut_samples_V is
    generic (
        DataWidth : INTEGER := 7;
...
architecture arch of myproject_sin_lut_samples_V is
    component myproject_sin_lut_samples_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    myproject_sin_lut_samples_V_rom_U :  component myproject_sin_lut_samples_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
