...
// ==============================================================
#ifndef __myproject_sin_lut_samples_V_H__
#define __myproject_sin_lut_samples_V_H__
...
struct myproject_sin_lut_samples_V_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(myproject_sin_lut_samples_V_ram) {
...
SC_MODULE(myproject_sin_lut_samples_V) {
...
myproject_sin_lut_samples_V_ram* meminst;


SC_CTOR(myproject_sin_lut_samples_V) {
meminst = new myproject_sin_lut_samples_V_ram("myproject_sin_lut_samples_V_ram");
